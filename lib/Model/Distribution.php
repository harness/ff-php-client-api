...
class Distribution implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'bucket_by' => 'string',
        'variations' => '\OpenAPI\Client\Model\WeightedVariation[]'
    ];
    ...
    {
        $this->container['bucket_by'] = $data['bucket_by'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bucket_by'] === null) {
            $invalidProperties[] = "'bucket_by' can't be null";
        }
     ...
     * Gets variations
     *
     * @return \OpenAPI\Client\Model\WeightedVariation[]
     */
