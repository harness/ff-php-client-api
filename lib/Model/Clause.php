 ...
 */
class Clause implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Clause';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['negate'] === null) {
            $invalidProperties[] = "'negate' can't be null";
        }
